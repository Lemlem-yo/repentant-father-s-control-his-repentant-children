...
class AdminBealatDetail extends StatefulWidget {
  const AdminBealatDetail({super.key});

  @override
  State<AdminBealatDetail> createState() => _AdminBealatDetailState();
}

class _AdminBealatDetailState extends State<AdminBealatDetail> {
  @override
